...
```
issued consumer token for owner=alice (token_id=a3f9c1d82b47)
...
# Custom secrets root:
xrlenv tokens revoke a3f9c1 --secrets-root /etc/xrlenv/secrets
```
...
tokens loaded from ~/.xrlenv/secrets:
  node      active   token_id=a3f9c1d82b47 digest_hint=a3f9c1 owner=default
  consumer  active   token_id=b72e440f9a11 digest_hint=b72e44 owner=default
  operator  grace    token_id=c01d8e3f5512 digest_hint=c01d8e remaining=4980s
