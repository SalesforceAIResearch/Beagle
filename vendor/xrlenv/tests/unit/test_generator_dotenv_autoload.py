...
xrlenv_plugins.benchmarks.<generator>.build_plan_gen`` did NOT
...
_GENERATORS_TO_VERIFY = (
    "xrlenv_plugins.benchmarks.swebench_verified.build_plan_gen",
...
def test_xrlenv_dotenv_off_disables_generator_autoload(
    ...
    probe_script = textwrap.dedent("""
        import os, sys
        from xrlenv_plugins.benchmarks.swebench_verified.build_plan_gen \
            import main
        rc = main([
