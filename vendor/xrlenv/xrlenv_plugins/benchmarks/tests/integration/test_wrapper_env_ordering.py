...
_WRAPPERS = [
    "swebench_verified", "deep_swe", "lhtb", "seta", "terminal_bench_2_1", "terminalworld", "swebench_pro",
]
...
_DEST_EVALUATORS = {
    ...
    "swebench_pro": "xrlenv_plugins.benchmarks.swebench_pro.run_oracle_sweep",
}
