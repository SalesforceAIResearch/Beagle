...
Review the diff in `{{ wt_dir }}/agents/openhands/vendor/`, run focused checks, fix bugs you
...
Steps:
1. Inspect `git -C {{ wt_dir }}/agents/openhands/vendor diff {{ parent_commit }}..HEAD`.
