...
Implement the plan at `{{ plan_path }}` in `{{ wt_dir }}/agents/openhands/vendor/`.
...
Only edit `{{ wt_dir }}/agents/openhands/vendor/`; do not edit the eval harness, scripts, configs,
