...
def scan_diff_locality(
    ...
    *,
    ...
    Budgets are env-tunable: ATELIER_SHARED_CORE_CHURN_BUDGET (default 30),
    ATELIER_GLOBAL_BUNDLE_CHURN_BUDGET (default 8).
    """
    removed = 0
    ...
    core_budget = _churn_budget("ATELIER_SHARED_CORE_CHURN_BUDGET", 40)
