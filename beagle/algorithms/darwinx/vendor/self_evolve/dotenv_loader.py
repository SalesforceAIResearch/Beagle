...
``MONET_EVAL_REPO_ROOT`` env var overrides this so a subprocess launched
...
# Module-level fallback used when MONET_EVAL_REPO_ROOT is unset.
...
def dotenv_path() -> Path:
    ...
    ``MONET_EVAL_REPO_ROOT`` can take effect for late-binding callers."""
