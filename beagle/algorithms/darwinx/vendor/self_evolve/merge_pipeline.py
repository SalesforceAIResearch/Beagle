...
class NodeMergePipeline:
    ...
    def _merge_secondary_into_child(self) -> None:
        ...
        try:
            ...
            if os.environ.get("ATELIER_SPECIALIST_CONTRACT", "").strip().lower() in ("1", "true", "yes", "on"):
    ...
    def _merge_validation_tasks(self) -> list[str]:
        ...
        max_parent_wins = _env_int("MONET_EVAL_MERGE_PARENT_WIN_VALIDATION_MAX", DEFAULT_MERGE_PARENT_WIN_VALIDATION_MAX)
        max_canaries = _env_int("MONET_EVAL_MERGE_RISK_SAMPLE_MAX", DEFAULT_MERGE_RISK_SAMPLE_MAX)
