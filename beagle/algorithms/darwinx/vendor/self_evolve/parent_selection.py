...
class LlmFirstStrategy(ParentSelectionStrategy):
    ...
    def _llm_pick(
        ...
        *,
        ...
        from atelier.matchfix_gate import chat_backend_from_credentials
        ...
        backend = chat_backend_from_credentials(
            model=os.environ.get("ATELIER_EQUIVALENCE_MODEL", "gpt-5.5"),
            provider=os.environ.get("ATELIER_EQUIVALENCE_PROVIDER", "sfr_gateway"),
            max_tokens=64,
        )
