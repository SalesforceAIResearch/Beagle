...
_GATEWAYS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("TRACE_ANALYZER_BASE_URL", ("TRACE_ANALYZER_API_KEY",)),
...
class OpenAIClient:
    ...
    def __init__(
        ...
        self.model = model or os.environ.get("TRACE_ANALYZER_MODEL") or "gpt-5.5"
    ...
    def complete(self, system: str, user: str) -> str:
        ...
        # rule-only proposers). Tunable via TRACE_ANALYZER_LLM_MAX_RETRIES /
        # TRACE_ANALYZER_LLM_BACKOFF_S.
        import random as _random
        import time as _time
        max_retries = int(os.environ.get("TRACE_ANALYZER_LLM_MAX_RETRIES", "5") or 5)
        backoff = float(os.environ.get("TRACE_ANALYZER_LLM_BACKOFF_S", "10") or 10)
